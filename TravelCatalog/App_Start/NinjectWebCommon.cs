[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(TravelCatalog.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(TravelCatalog.App_Start.NinjectWebCommon), "Stop")]

namespace TravelCatalog.App_Start
{
    using System;
    using System.Web;
    ...
    using TravelCatalog.Data;
    using TravelCatalog.Data.EfDbSetWrappers;
    using TravelCatalog.DataServices.Contracts;
    using TravelCatalog.DataServices;
